    ...
    <div className="flex flex-col h-full overflow-y-auto" style={{ background: 'var(--gia-bg)', padding: '20px 16px', gap: '16px' }}>
      ...
      <div className="px-3 py-3 rounded-xl text-xs leading-relaxed" style={{ background: 'rgba(16,185,129,0.08)', border: '1px solid rgba(16,185,129,0.15)', color: 'var(--gia-muted)' }}>
        ...
        <ul className="space-y-1.5 pl-3" style={{ listStyle: 'disc' }}>
          ...
          <li><strong style={{ color: '#34d399' }}>Voice Control</strong> — Set a wake word phrase, choose recognition language, and toggle TTS for spoken responses. Background wake word detection is scaffolded but disabled in this build (coming in a later release) — the diagnostics section will show a test-data preview rather than real detection until then.</li>
