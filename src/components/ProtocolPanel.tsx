    ...
    >
      <div className="flex items-center justify-between px-4 py-3 bg-zinc-900/80 border-b border-zinc-800 shrink-0">
        <div className="flex items-center gap-2.5">
          ...
          <span className="text-[10px] font-bold tracking-[0.2em] text-zinc-400 uppercase">Protocols</span>
          {active.length > 0 && (
        ...
        <div className="flex items-center gap-1">
          {consoleProtocols.length > 0 && (
            <button onClick={clearConsoleProtocols} className="p-1.5 rounded-lg hover:bg-zinc-800 transition-colors text-zinc-500">
              <Trash2 size={12} />
            </button>
          )}
