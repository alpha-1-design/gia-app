...
const FALLBACK_PROVIDERS: ProviderDef[] = [
  ...
  { id: 'mistral',      label: 'Mistral AI',    baseUrl: 'https://api.mistral.ai/v1',                  defaultModel: 'mistral-small-latest', needsApiKey: true, listingType: 'openai',   aliases: [] , apiKeyUrl: 'https://console.mistral.ai/api-keys' },
  { id: 'xai',          label: 'xAI (Grok)',    baseUrl: 'https://api.x.ai/v1',                        defaultModel: 'grok-4.5',         needsApiKey: true,  listingType: 'openai',     aliases: ['grok'] , apiKeyUrl: 'https://console.x.ai' },
  { id: 'togetherai',   label: 'Together AI',   baseUrl: 'https://api.together.xyz/v1',                defaultModel: 'meta-llama/Llama-3.3-70B-Instruct-Turbo', needsApiKey: true, listingType: 'openai', aliases: ['together'] , apiKeyUrl: 'https://api.together.xyz/settings/api-keys' },
  { id: 'huggingface',  label: 'HuggingFace',   baseUrl: 'https://api-inference.huggingface.co/v1',   defaultModel: 'Qwen/Qwen2.5-72B-Instruct', needsApiKey: true, listingType: 'huggingface', aliases: ['hf'] , apiKeyUrl: 'https://huggingface.co/settings/tokens' },
  { id: 'perplexity',   label: 'Perplexity',    baseUrl: 'https://api.perplexity.ai',                  defaultModel: 'sonar-pro',        needsApiKey: true,  listingType: 'openai',     aliases: ['pplx'] , apiKeyUrl: 'https://www.perplexity.ai/settings/api' },
  { id: 'cohere',       label: 'Cohere',        baseUrl: 'https://api.cohere.ai/v1',                   defaultModel: 'command-r-plus',   needsApiKey: true,  listingType: 'openai',     aliases: [] , apiKeyUrl: 'https://dashboard.cohere.com/api-keys' },
  { id: 'fireworks',    label: 'Fireworks AI',  baseUrl: 'https://api.fireworks.ai/inference/v1',      defaultModel: 'accounts/fireworks/models/llama-v3p3-70b-instruct', needsApiKey: true, listingType: 'openai', aliases: [] , apiKeyUrl: 'https://fireworks.ai/account/api-keys' },
  { id: 'deepinfra',    label: 'DeepInfra',     baseUrl: 'https://api.deepinfra.com/v1/openai',        defaultModel: 'meta-llama/Meta-Llama-3.1-70B-Instruct', needsApiKey: true, listingType: 'openai', aliases: [] , apiKeyUrl: 'https://deepinfra.com/dash/api_keys' },
  { id: 'ai21',         label: 'AI21 Labs',     baseUrl: 'https://api.ai21.com/studio/v1',             defaultModel: 'jamba-1.5-mini',   needsApiKey: true,  listingType: 'openai',     aliases: [] , apiKeyUrl: 'https://studio.ai21.com/account/api-key' },
  { id: 'replicate',    label: 'Replicate',     baseUrl: 'https://api.replicate.com/v1',               defaultModel: 'meta/meta-llama-3-70b-instruct', needsApiKey: true, listingType: 'openai', aliases: ['rep'] , apiKeyUrl: 'https://replicate.com/account/api-tokens' },
  { id: 'nvidia',       label: 'NVIDIA NIM',    baseUrl: 'https://integrate.api.nvidia.com/v1',          defaultModel: 'nvidia/llama-3.1-nemotron-ultra-253b-v1', needsApiKey: true, listingType: 'openai', aliases: ['niv'] , apiKeyUrl: 'https://build.nvidia.com' },
  // Local providers
